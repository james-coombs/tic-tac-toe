...
/***/ function(module, exports, __webpack_require__) {
	...
	var userEvents = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateUser = function onCreateUser(event) {
	  ...
	  $('.user-actions').hide();
	  api.createUser(event.target).done(ui.onCreateUserSuccess).fail(ui.createUserOnError);
	};

	var onSignInUser = function onSignInUser(event) {
	  event.preventDefault();
	  api.signInUser(event.target).done(ui.signInSuccess).fail(ui.createUserOnError);
	};
	...
	var onSignOutUser = function onSignOutUser() {
	  ...
	  $('.user-actions').hide();
	  $('.game-querys').hide();
	  api.signOutUser().done(ui.signOutSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInUser = function signInUser(form) {
	  return $.ajax({
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://project-1-tic-tac-toe-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateUserSuccess = function onCreateUserSuccess(data) {
	  if (data) {
	...
	var createUserOnError = function createUserOnError() {
	...
	var signOutUserSuccess = function signOutUserSuccess() {
	  $('#new-game-button').hide();
	  $('.user-actions').hide();
	  $('.game-querys').hide();
	};
	...
	module.exports = {
	  ...
	  createUserOnError: createUserOnError,
	  changePasswordSuccess: changePasswordSuccess,
	  signOutUserSuccess: signOutUserSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGameById = function onGetGameById(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getGameById(data).done(ui.getGameByIdSuccess).fail(ui.onError);
	};
	...
	var onGetGamesPlayed = function onGetGamesPlayed(data) {
	  event.preventDefault();
	  api.getGamesPlayed(data).done(ui.getGamesPlayedSuccess).fail(ui.onError);
	};

	var gameResolutionXorO = function gameResolutionXorO() {
	  var victor = void 0;
	...
	var gameResolutionTie = function gameResolutionTie() {
	  if (gameTurns === 9) {
	...
	var hideBoardAfterResolution = function hideBoardAfterResolution() {
	  if (gameIsOver === true) {
	    $('.game-board').hide();
	  }
	};
	...
	module.exports = {
	  onNewGame: onNewGame,
	  onGetGameById: onGetGameById,
	  gameBoardArray: gameBoardArray,
	  gameTurns: gameTurns,
	  gameIsOver: gameIsOver,
	  setGame: setGame,
	  gameResolutionXorO: gameResolutionXorO,
	  gameResolutionTie: gameResolutionTie,
	  onGetGamesPlayed: onGetGamesPlayed,
	  hideBoardAfterResolution: hideBoardAfterResolution
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(i, value, gameIsOver) {
	  $.ajax({
	...
	var getGamesPlayed = function getGamesPlayed(data) {
	  return $.ajax({
	    url: app.host + '/games',
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGameByIdSuccess = function getGameByIdSuccess(data) {
	  app.game = data.game;
	  $('.info').text('You got game id: ' + data.game.id + ' the game array looked like: [' + data.game.cells + '] Was the game over? ' + data.game.over + ' The id of the player was: ' + data.game.player_x.id + ' That player\'s email is: ' + data.game.player_x.email);
	};

	var getGamesPlayedSuccess = function getGamesPlayedSuccess(data) {
	  app.game = data.game;
	...
	module.exports = {
	  ...
	  onError: onError,
	  getGameByIdSuccess: getGameByIdSuccess,
	  getGamesPlayedSuccess: getGamesPlayedSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2f2036cafa4516406b8b67176fb42a41.jpg";
